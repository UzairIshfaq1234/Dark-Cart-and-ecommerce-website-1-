...
<body>
    <div class="container mt-3 mb-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            ...
            <h6 class=" mt-1 heading212">COMPLETED <span class="head21">ORDERS</span></h6>
        ...
        <div class="searchbytach">
            <form action="adminusercompletedorder.php" method="POST">
...
// echo $trackorder1;
        ...
        for ($i = 0; $i < $gettingrows1; $i++) {
            ...
            if(isset($_POST['getsearched']))
            {
                ...
                if($ordertrackid1==$trackorder1 and $orderstatusbydigit1 == 1 )
                {
            ...
            <div class='statusitems'>
                <form action='updatecompletedorderstatusbyadmin.php?updatedid=$ordertrackid1' method='POST'>
            ...
            <div>
                ...
                <a href='deletecompletedorderbyadmin.php?deleteid1=$ordertrackid1' class='itemdelete'><button class='btn btn-primary exrtasub1' name='delete12'>Delete Order</button>
                </a>
            ...
            if ($orderstatusbydigit1 == 1 and $ordertrackid1==!$trackorder1) {
                echo "
            <div class='firstbox'>
    <div class='imageitem'>
        <img src='sellingitempics/$productpicture12' alt='' class='orderitemimage'>
