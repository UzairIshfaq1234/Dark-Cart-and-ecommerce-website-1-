...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$exitso = "SELECT * FROM `adminlogin` WHERE gmail='$gmail' AND password='$password'";
		...
		<div class="container-fluid">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
			  ...
			  <li class="nav-item">
				<a class="nav-link active mycolor2" href="login.php">login</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link mycolor2" href="signup.php">signup</a>
			  </li>
              <li class="nav-item">
				<a class="nav-link  avtived" href="adminlogin.php">Admin-Login</a>
			  </li>
