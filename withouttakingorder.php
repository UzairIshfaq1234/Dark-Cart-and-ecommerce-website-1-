...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  avtived" href="withouttakingorder.php">Accessiories</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active mycolor2 " aria-current="page" href="adminlogin.php">Admin-login</a>
    ...
    for ($i = 0; $i < $gettingrows; $i++) {
        ...
        if ($status21 == 'In_Stock') {
            echo "
            <a href='login.php?productid=$productid1' class='getstrat3'><button class='getstratbtn3 hoveingeffect'>Order Now</button></a>
            ";
        } else {
            echo "
